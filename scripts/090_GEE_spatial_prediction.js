...
//print('Projection, crs, and crs_transform:', stack.projection());

//Map.addLayer(prediction);

Export.image.toDrive({
  image: prediction,
  description: 'monthly_prediction_' + iterator,
  region: hessen,
  scale: 100,
  fileFormat: "GeoTIFF",
  fileNamePrefix: 'monthly_prediction_' + iterator,
  crs: "EPSG:4326",
  folder: "gedi",
});
...
print("spat_pred", spat_pred_month)
